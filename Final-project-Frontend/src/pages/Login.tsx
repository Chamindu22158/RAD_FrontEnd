                ...
                <div className="bg-white rounded-2xl shadow-2xl border border-amber-100 overflow-hidden">
                    ...
                    <div className="px-8 py-8">
                        ...
                        <p className="text-center text-gray-600 text-sm mt-6">
                            Don't have an account? <a href="/signup" className="text-amber-600 font-semibold hover:text-amber-700">Sign up here</a>
                        </p>
                    </div>
                </div>
                
                {/* Footer */}
                <p className="text-center text-gray-600 text-xs mt-6">Secure login • Your data is protected</p>
            </div>
        </div>
    );
};
